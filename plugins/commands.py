...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Contact Me:', url='https://t.me/Innocent0NEme'),
            InlineKeyboardButton('  Instagram: ', url='https://www.instagram.com/abdullahkhanie/')
        ],
        [
...
async def repo_(client, message):
    ...
    await message.reply("<b>The source code of this bot is public", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
